...
pub(crate) const CLI_EXCHANGE_GRANT_PREFIX: &str = "scope_otc_";
pub(crate) const CLI_SESSION_ID_PREFIX: &str = "cli_sess_";
pub(crate) const CLI_SESSION_TOKEN_PREFIX: &str = "scope_cli_";
pub(crate) const CLI_DEVICE_CODE_PREFIX: &str = "scope_device_";
pub(crate) const FIRST_PUSH_TOKEN_BYTES: usize = 32;
pub(crate) const CLI_BROWSER_LOGIN_TTL_SECS: u64 = 5 * 60;
pub(crate) const CLI_DEVICE_LOGIN_TTL_SECS: u64 = 10 * 60;
pub(crate) const CLI_EXCHANGE_GRANT_TTL_SECS: u64 = 5 * 60;
pub(crate) const CLI_SESSION_TTL_SECS: u64 = 30 * 24 * 60 * 60;
