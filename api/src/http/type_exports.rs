...
use scope_api_contract::{
    ...
    RepositoryMemberPermissions, RepositoryRunAttemptState, RepositoryRunCacheColdReason,
    RepositoryRunCacheFinalState, RepositoryRunCachePreparation, RepositoryRunJobState,
    RepositoryRunState, RepositoryRunStepState, RepositoryRunTerminalReason,
    ...
    RequestRevisionResponse, RequestState, RequestSummaryResponse, RunRunnerSelection,
...
pub(crate) fn export_api_types(output_path: &Path) {
    ...
    let declarations = [
        ...
        declaration::<RunRunnerSelection>(&ts_config),
        ...
        declaration::<RepositoryRunnerState>(&ts_config),
        declaration::<RepositoryRunnerResponse>(&ts_config),
        declaration::<RepositoryRunnersResponse>(&ts_config),
...
fn api_route_template_declarations() -> String {
    let routes = [
        ...
        ("repoRunners", routes::REPO_RUNNERS),
