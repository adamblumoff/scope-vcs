...
use scope_api_contract::{
    ...
    CreateRequestDiscussionRequest, DeviceLoginPollResponse, DeviceLoginStartResponse,
    DeviceLoginStatus, EditRequestIdentityRequest, FileChangeKind, FirstPushTokenResponse,
    FirstPushTokenStatus, GitOid, GitPushTokenResponse, HistoryRewriteAction,
    HistoryRewriteRequest, LeaveRequestResponse, MarkRequestDiscussionReadRequest,
    ReadyRequestRequest, RemoveRequestInviteeRequest, ReopenAndReplyRequest, RepoChangeEvent,
    RepoChangeKind, RepoConfig, RepoConfigHistory, RepoConfigResponse, RepoConfigVisibility,
    RepoConfigVisibilityRule, RepoInitResponse, RepoPublicationState,
    RepoRequestPermissionsResponse, RepoSummaryResponse, RepositoryAccessResponse, RepositoryActor,
    RepositoryInviteState, RepositoryMemberPermissions, RequestActivityPageResponse,
    RequestActorRole, RequestActorSummaryResponse, RequestAudience, RequestChangeBlockResponse,
    RequestCloseResponse, RequestDetailResponse, RequestDiscussionChangesResponse,
...
pub(crate) fn export_api_types(output_path: &Path) {
    ...
    let declarations = [
        ...
        declaration::<RepositoryOperationsResponse>(&ts_config),
...
fn api_route_template_declarations() -> String {
    let routes = [
        ...
        ("repoOperations", routes::REPO_OPERATIONS),
