...
pub(crate) fn export_api_types(output_path: &Path) {
    ...
    let declarations = [
        ...
        declaration::<RequestAssessmentOutcome>(&ts_config),
        declaration::<RequestReviewExitReason>(&ts_config),
        ...
        declaration::<RequestQueueSection>(&ts_config),
        ...
        declaration::<RequestInviteeMutationResponse>(&ts_config),
        declaration::<LeaveRequestResponse>(&ts_config),
        ...
        declaration::<RequestCloseResponse>(&ts_config),
...
fn api_route_template_declarations() -> String {
    let routes = [
        ...
        ("repoRequestReady", routes::REPO_REQUEST_READY),
        ("repoRequestWorking", routes::REPO_REQUEST_WORKING),
        ("repoRequestHold", routes::REPO_REQUEST_HOLD),
        (
            "repoRequestRequestChanges",
            routes::REPO_REQUEST_REQUEST_CHANGES,
        ),
        ("repoRequestAssessment", routes::REPO_REQUEST_ASSESSMENT),
