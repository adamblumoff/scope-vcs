...
import type { RepoInviteLookup, RepoInviteTokenInput } from '@/api/types'
...
function InviteRoute() {
  ...
  return <InvitePage invite={invite} token={params.token} />
}
...
function InvitePage({
  ...
  async function onAccept(input: RepoInviteTokenInput) {
    ...
    setAccepting(true)
    try {
      const accepted = await acceptInvite({ data: input })
      await navigate({
        params: {
