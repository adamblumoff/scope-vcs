...
impl MetadataStore {
    pub fn start_cli_browser_login(
        &self,
        app_origin: &str,
        callback_url: &str,
    ...
    pub fn complete_cli_browser_login(
        &self,
        request_id: &str,
        user: &UserAccount,
    ...
    pub fn exchange_cli_browser_login(
        &self,
        request_id: &str,
        request_secret: &str,
        callback_code: &str,
    ...
    pub fn create_cli_exchange_grant(
        &self,
        user: &UserAccount,
    ...
    pub fn exchange_cli_grant(&self, exchange_token: &str) -> Result<CliSessionToken, ApiError> {
    ...
    pub fn list_cli_sessions_for_user(
        &self,
        user: &UserAccount,
    ...
    pub fn revoke_cli_session_for_user(
        &self,
        user: &UserAccount,
        session_id: &str,
    ) -> Result<(), ApiError> {
